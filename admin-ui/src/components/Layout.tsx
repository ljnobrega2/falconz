...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/tpc-clientes':         'Clientes — Carteira Frete',
  '/affiliates-wallet':    'Carteira de Afiliados',
  '/onboarding-requests':  'Cadastros (Onboarding)',
  '/motoboy-dashboard':    'Dashboard Motoboy',
  '/motoboy-carteira':     'Carteira Motoboy',
  '/motoboy-fechamento':   'Fechamento Diário Motoboy',
  '/motoboy-config':       'Configurações Motoboy',
  '/tpc-transacoes':       'Transações TPC',
  '/tpc-config':           'Configurações TPC',
