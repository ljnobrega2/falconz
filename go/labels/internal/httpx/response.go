// Package httpx fornece helpers de resposta JSON para todos os handlers do labels-service.
// Contrato de resposta: {"ok": true, ...} / {"ok": false, "erro": "mensagem"}
// Espelha o mesmo contrato do wallet-service para consistência entre serviços Go.
package httpx
